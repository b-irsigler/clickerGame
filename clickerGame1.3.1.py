...
music_names = ['sound/LionKing.ogg', 'sound/Lazerhawk.mp3', 'sound/Ruegenwalder.mp3']
...
class Game:
    ...
    def level_up(self):
        if self.level < len(background_names):
            ...
            pygame.mixer.music.queue(music_names[-1])
    ...
    def menu(self):
        ...
        while self.running:
            ...
            if self.highscore:
                highscore_text = self.font.render(str(f'Highscore: {self.highscore:,}'), True, BLUE)
